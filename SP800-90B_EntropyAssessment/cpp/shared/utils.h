...
// utils.h was originally produced by NIST (version 1.1.7) and modified by 
...
// 
// Modifications by Teron Labs to utils.h in July 2024 are as follows:
//     Alter attempts to assign to a string: "... '%s' ...", file_path
//		to avoid the compiler warning that "right operand of comma operator has no effect"
//		by creating a temporary string msg and assigning each component to msg individually.
//
// Change version from 1.1.7 to 1.1.7.post1
//
