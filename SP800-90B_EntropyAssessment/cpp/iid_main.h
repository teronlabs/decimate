// iid_main.h was created by Teron Labs in July 2024 to facilitate export of iid_main from iid_main.cpp to Python. 
...
std::string iid_main(int argc, char* argv[]);